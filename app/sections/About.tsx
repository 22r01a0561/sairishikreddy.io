            ...
            justify-center lg:max-w-[1212.8px]">
                ...
                <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
                    ...
                    md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
                        ...
                        I'm always excited to tackle new challenges and pick up new tech skills - it helps 
                        me grow in so many ways. I also enjoy creating beautiful user interfaces and 
                        building full-stack applications from the ground up." />

                        <AnimatedBody
                            delay={0.1}
                            text="I enjoy creating clean, user-friendly interfaces and developing smart, 
                            ...
                            I also enjoy sharing what I know and working with others to build meaningful 
                            solutions. I'm a quick learner and always eager to take on new challenges."
                        />

                        <AnimatedBody
                            delay={0.2}
                            text="Right now, I'm working on some exciting projects, and I can't wait to 
